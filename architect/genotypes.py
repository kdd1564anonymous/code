...
class Structure:
        ...
        for idx, node_info in enumerate(genotype):
            ...
            for node_in in node_info:
                ...
                assert len(node_in) == 2 and node_in[
                    1] < idx + input_num, 'invalid in-node : {:}'.format(node_in)
    ...
    @staticmethod
    def str2structure(xstr, input_num=1):
        ...
        return Structure(genotypes, input_num)
