...
DARTS_SPACE = [
    'none', 'skip_connect', 'sep_conv_3x3', 'sep_conv_5x5', 'dil_conv_3x3',
...
class GDAS_Reduction_Cell(nn.Module):
    def __init__(self, C_prev_prev, C_prev, C, reduction_prev, multiplier,
        ...
        self.ops1 = nn.ModuleList([
            nn.Sequential(
                ...
                nn.Conv2d(C,
                          ...
                          padding=(1, 0),
                          groups=8,
                          bias=False), nn.BatchNorm2d(C, affine=True),
                nn.ReLU(inplace=False),
        ...
        self.ops2 = nn.ModuleList([
            nn.Sequential(nn.MaxPool2d(3, stride=1, padding=1),
                          nn.BatchNorm2d(C, affine=True)),
            nn.Sequential(nn.MaxPool2d(3, stride=2, padding=1),
                          nn.BatchNorm2d(C, affine=True))
        ])
